  ...
  <p align="justify">
    ...
    <p align="justify">
      ...
      is not a surprise that studios are very interested in implementing these AI tools that can
       replace human workers. Besides, an AI tool doesn’t need breaks, vacations, or sleep so
    ...
    <p align="justify">
     ...
     and other creative industries have always dragged is the ‘crunch’ culture. What is the
     ‘crunch’ culture? This is a term to refer to when VFX teams have an excessive workload,
     which involves long and intense periods of work, strict deadlines, and a lot of stress for the
     workers. These ‘crunch’ moments can be real nightmares for the VFX artists. In this and
     ...
     creative parts of the work that AI tools can’t manage.
    </p>
    <p align="justify">
       Finally, AI and CPUs technologies will reduce VFX’s footprints. In the article, “The
       future of visual effects,” Ruczak, Knight (Academy and BAFTA member) explained how CPU
       ...
       a flood scene without waste water, because CGI technology still can’t achieve realistic
    ...
    <p align="justify">
     ...
     can't replicate the realism of the practical effects. However, trusting to the ‘Law of
     Accelerating Returns’ by futurist Ray Kurzweil, technologies do not progress in a linear way,
     ...
     curing many of the illnesses of the industry such as the ‘crunch’ culture.
    </p>

    <b>How Will AI Change Production Design?</b>
    <p align="justify">
       Worlds such as Harry’s potter or Lord of the rings are so attractive because the
      ...
      buy the fictional scenarios presented. Production design is critical even for non-fiction
       movies. Audiences can’t invest their attention in historical scenarios such as Titanic or
       Ben-Hur if the pre-production wouldn’t take the time to accurately recreate these scenarios,
    ...
    <p align="justify">
      Script analysis is one of the first steps during the pre-production process. All movies
       ...
       the purpose of ensuring the movie’s success. Using deep learning AI can analyze hundreds
       ...
       whole industry wouldn’t exist. It is important to mention this, because the use of AI to edit
       and improve a script can bring criticism from the more puristic moviegoers and filmmakers.
       In an artistic way, this is understandable, an AI can’t match the creativity levels that the
      ...
      successes. They also can lead to catastrophic disasters. However, industry can find a big
       problem if they decide to trust too much in the AI’s judgment, because AI is an algorithm
       made to learn from past information, it is very likely that AI will always predict as ‘successful’
    ...
    <p align="justify">
     ...
     independent project, where the budget can’t pay a superstar, the process of casting involves
     ...
     predict the possible success of a non-famous actor using AI based on the actor’s profile.
    ...
    <p align="justify">
     ...
     ‘Morgan’. As we know trailers are one of the main techniques studios use to hook audiences
     ...
     about trailers performance, and the impact they have had in movie’s box offices, AI can use
     ...
     Trailers are meant to sell the movie. They are a marketing tool. It doesn’t matter if you are a
    ...
    <p align="justify">
       ...
       can’t. Therefore, can we assume AI is capable of building fictional worlds? or assist in
    ...
    <p align="justify">
       A good audiovisual production wouldn’t feel good without good audio, this sounds
       obvious but let’s stop to think about all the benefits that audio design means for movie’s
       ...
       sound effect that makes them feel real enough to make the viewer think “damn that was a
       hard punch” or “I don't really think he hurt him with that punch” because not all the punches
       have the same meaning in movies. What about dialogues? Maybe Marlon Brandon wouldn’t
    ...
    <p align="justify">
      The truth is that AI’s skill to learn makes it a powerful tool to generate new and
     precise soundtracks and sound effects. AI can use randomized algorithms alongside text
     inputs to generate new soundtracks in seconds, saving time and money for movie’s
     ...
     made with programming, when human intelligence doesn’t. It can think in both ways linear
     and abstract. Based on this premise we can say that using AI is in fact plagiarism if it is used
     to generate new sounds, but also we can’t deny that some algorithms such as Neural
    ...
    <p align="justify">
       ...
       achieve great results. Movies wouldn’t be as magical as they are without the creativity and
    ...
    <p align="justify">
       Have you ever wondered “How do Hollywood's actors look well in all scenes?”
       ...
       into action their skills they don’t really need a computer or any other digital device, so how
    ...
    <p align="justify">
     ...
     However, deepfake is still a relatively new technology, and many legal points haven’t been
     ...
     that doesn’t have a cure because of that the actor’s health has been deprecated. However,
    ...
    <p align="justify">
     ...
     doesn't let him do it. Voice actors could still work even if their throats can’t reach the tones
     ...
     can’t. Anyways, a constant in this whole topic is the fact that technology improves at a fast
     ...
     human’s creativity, so far it is impossible that an AI can generate all the crazy and unique
    ...
    <p align="justify">
       ...
       risk their health in order to make these types of scenes as real as possible. Let’s remember
       ...
       general are a core part of a movie’s success. There are many reasons for that such as they
       ...
       they can finish the movie. Therefore, studios can’t risk their actors' health no matter what, so
    ...
    <p align="justify">
       In the year 1982, during the filming of the movie “The Twilight Zone: The Movie” the
      ...
      more recently the never-released movie Rust have had incidents like this. The origin of these
       ...
       these scenes using digital components that will not risk anyone’s life. Besides, this could be
    ...
    <p align="justify">
       ...
       replacement. Something constant in this paper is the fact that AI can’t replicate human
       ...
       want to film, but they can’t control in totality the final outcome. This has led to great scenes
    ...
    <p align="justify">
      There are many good reasons to implement AI in scenes that need stunt performers;
       ...
       However, the people of the industry can’t forget one of their most important communities, a
    ...
    <p align="justify">
     ...
     department. He was involved in productions such as ‘How I met your mother’ or ‘Hollywood
     Residential’.
    </p>
    <p align="justify">
       ...
       tool is becoming the only tool. A way that Adam used to explain is that “An actors’ entire job
       is to represent humanity and what it is to be human” this is definitely an interesting quote,
       ...
       human involvement less necessary, perse taking out “humanity” from the process. Another
    ...
    <p align="justify">
     ...
     because the use of AI will inevitably block someone else's growth. If humanity it’s an integral
     ...
     barriers to embrace their differences and make them special, because in Adam’s beliefs
    ...
    <p align="justify">
     ...
     Runway’s AI to analyze Lionsgate’s scripts, and with them generate new scripts that have
    ...
    <p align="justify">
     ...
     that AI will make it more affordable to film this type of movie, considering that it’s always a
     ...
     his answer, he mentioned a concept called ‘opposition of ideas’. Adam thinks that something
     ...
     explains it’s really important for genres like comedies or horrors. This is because AI uses
     past data to generate its outcome, so it is natural to think that the ‘unexpected’ factor that it’s
    ...
    <p align="justify">
     ...
     be replaced for technology or other alternatives in order to ensure production’s safety.
    ...
    <p align="justify">
      The last question was, should studios create an “AI producer” that supervises the use
    ...
    <p align="justify">
     ...
     make revenue. It doesn’t matter if they are small or big studios; their main goal is going to be
    ...
    <p align="justify">
       ...
       probably biggest illness in their industry, the ‘crunch’ culture, an illness that has ended
       careers forever.
    </p>
    <p align="justify">
